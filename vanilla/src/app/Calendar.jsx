...
// used but hidden by default in Calendar
import { EditEventModal } from "../components/eventModals/EventModals"
// used but hidden by default in top-level Calendar
...
export function Nav() {
  ...
  } = useCalendar() // importing only specific contexts from the CalendarContect
